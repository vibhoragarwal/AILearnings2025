...
response = client.chat.completions.create(
  ...
  messages=[
    {"role": "system", "content": "Ur cobol to java moernization expert, convert the code to modern Java code. DO NOT EXPLAIN CODE, convert to Java"},
    {"role": "user", "content": f"Modernize Cobol Code: [{content}]."}
  ]
)
