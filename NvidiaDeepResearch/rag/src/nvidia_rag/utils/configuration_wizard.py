...
def configfield(
    ...
    **kwargs: Any,
    ...
    :type env: bool
    :param env_name: Custom environment variable name. If not provided, will use auto-generated name.
    :type env_name: Optional[str]
    ...
    def print_help(
        ...
        *,
        ...
        for (
            ...
            # Check if custom env_name is provided
            custom_env_name = val.metadata.get("env_name")
            if custom_env_name:
